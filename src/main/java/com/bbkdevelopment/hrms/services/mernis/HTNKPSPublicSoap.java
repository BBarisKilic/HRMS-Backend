...
public class HTNKPSPublicSoap
{
    ...
    public HTNKPSPublicSoap(){}

    public HTNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HTNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HTNExtendedSoapSerializationEnvelope envelope= new HTNExtendedSoapSerializationEnvelope(HTNExtendedSoapSerializationEnvelope.VER11);
