...
public class HTNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HTNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HTNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HTNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HTNDateTimeConverter dateTimeConverter = new HTNStandardDateTimeConverter();

    public HTNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HTNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HTNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HTNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HTNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HTNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
