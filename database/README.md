# <p align="center">Human Resources Management System</p> <p align="center">Database</p>

<p align="center"><img src="hrms.png" width="1000"></p>
...
CREATE TABLE public.job_advertisement(
	...
	CONSTRAINT fk_job_advertisement_employees FOREIGN KEY(employee_id) REFERENCES public.employees(id),
